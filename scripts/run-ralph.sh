#!/bin/bash
# ⚠️ Set these in your shell environment or .env file — never hardcode API keys
...
REPO='D:/Coding-Files/GitHub/VIZA-monorepo'
CLAUDE_PROMPT='# Ralph - Existing Repo Mode
