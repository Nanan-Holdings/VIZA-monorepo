/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f4140567bb0cc1a7efaa1e54af474ed)
// Runtime types generated with workerd@1.20260804.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	CRITICAL_NOTIFICATIONS_QUEUE: Queue;
	DOCUMENT_STATUS_QUEUE: Queue;
	...
	RESILIENCE_STATE: DurableObjectNamespace<import("./src/index").ResilienceState>;
	CONCURRENCY_GATE: DurableObjectNamespace<import("./src/index").ConcurrencyGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ResilienceState" | "ConcurrencyGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PROJECT_REF" | "SUPABASE_MANAGEMENT_API_URL" | "VIZA_RESILIENCE_REPLAY_URL" | "VIZA_RESILIENCE_KEY_ID" | "WATCHDOG_AUTO_RESTART" | "WATCHDOG_CONFIRMATIONS" | "WATCHDOG_CONFIRMATION_INTERVAL_MS" | "WATCHDOG_PROBE_TIMEOUT_MS" | "WATCHDOG_RESTART_COOLDOWN_SECONDS" | "WATCHDOG_RESTART_WINDOW_SECONDS" | "WATCHDOG_MAX_RESTARTS_PER_WINDOW" | "WATCHDOG_RESTART_LEASE_SECONDS" | "WATCHDOG_REPLAY_BATCH_SIZE" | "WATCHDOG_REPLAY_LEASE_SECONDS" | "WATCHDOG_MAX_BODY_BYTES">> {}
}
