...
| Singapore SG Arrival Card | Live assisted | Dry-run validates `SG_ARRIVAL_CARD`; live worker uses an application-scoped VIZA alias, fills ICA's visitor or Long-Term Pass route, submits after Review, and stores the official confirmation PDF for the applicant result panel. |
