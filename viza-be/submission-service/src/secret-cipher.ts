 ...
 *
 * MIRROR OF viza-be/agent-backend/src/utils/secret-cipher.ts. The two files
 * MUST stay byte-equivalent below the file-header comment so a value
 * encrypted by the runner can be decrypted by the API and vice versa.
 */
