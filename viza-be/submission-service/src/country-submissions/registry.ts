...
const CONFIGS: ProviderConfig[] = [
  ...
  },
  {
    ...
    notes: "Single continuous session (no persistent portal account): terms modal, delivery-location tab, application-form tab with inline email OTP verification, then every field, halting at the CAPTCHA + \"確認資料\" submit boundary. No payment in this session — NIA approval + payment happen later on the official site.",
  },
  {
    countryCode: "ID",
