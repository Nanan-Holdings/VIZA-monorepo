...
export function classifyIndonesiaPortalSnapshot(
  ...
  // Payment gateway error documents often keep a /payment URL. Detect the
  // WAF/CDN response before the generic payment-URL rule so a blocked cloud
  // browser is not reported as a live bank-authorization checkpoint.
  if (
