/** Official CEAC Designate Location options captured from the live start-page select. */
export const CEAC_DS160_LOCATION_OPTIONS = [
  ["TIA", "ALBANIA, TIRANA"],
  ["ALG", "ALGERIA, ALGIERS"],
  ["LUA", "ANGOLA, LUANDA"],
  ...
  ["NHA", "JAPAN, NAHA"],
  ["KBO", "JAPAN, OSAKA/FUKUOKA"],
  ["TKY", "JAPAN, TOKYO/SAPPORO"],
  ["JRS", "JERUSALEM"],
  ["AMM", "JORDAN, AMMAN"],
...
export const CEAC_DS160_LOCATION_OPTION_COUNT = 217;
