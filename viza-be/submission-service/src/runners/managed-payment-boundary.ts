...
export async function executeManagedPaymentBoundary(_input: {
  country: string;
  visaType: string;
  ...
  return { status: "managed_payment_adapter_unavailable", reason: "payment_removed: automated payment has been removed; official fee checkpoint needs attention", receiptId: null, reference: null };
}
