...
function optionLabel(value: string | null): string | null {
  ...
  return aliases[value.toUpperCase()] ?? value.replaceAll("_", " ");
}
...
export function buildPhEtravelFieldPlan(payload: PhEtravelPortalPayload): PhEtravelFieldPlanItem[] {
  return [
    ...
    { key: "passport_issuing_authority", labels: ["Passport Issuing Authority", "Country of Issue"], kind: "choice", value: optionLabel(payload.passportIssuingAuthority), required: true },
    { key: "nationality", labels: ["Citizenship", "Nationality"], kind: "choice", value: optionLabel(payload.nationality), required: true },
    { key: "country_of_birth", labels: ["Country of Birth"], kind: "choice", value: optionLabel(payload.countryOfBirth), required: true },
    { key: "country_of_residence", labels: ["Permanent Country of Residence", "Country of Residence"], kind: "choice", value: optionLabel(payload.countryOfResidence), required: true },
    ...
    { key: "occupation", labels: ["Occupation"], kind: "choice", value: optionLabel(payload.occupation), required: true },
    ...
    { key: "traveller_type", labels: ["Traveller Type", "Traveler Type"], kind: "choice", value: optionLabel(payload.travellerType ?? "AIRCRAFT_PASSENGER") },
    { key: "airline", labels: ["Airline Name", "Name of Airline/Vessel"], kind: "choice", value: optionLabel(payload.airlineOrVesselName) },
    { key: "flight_number", labels: ["Flight Number", "Vehicle/Vessel Number"], kind: "text", value: payload.flightNumber, required: true },
    { key: "origin_country", labels: ["Country of Origin"], kind: "choice", value: optionLabel(payload.originCountry), required: true },
    ...
    { key: "port_of_entry", labels: ["Airport/Port of Destination in the Philippines", "Port of Entry", "Airport of Destination"], kind: "choice", value: optionLabel(payload.portOfEntry), required: true },
    { key: "with_transit", labels: ["With Transit", "Connecting Flight"], kind: "choice", value: yesNo(payload.withTransit) },
    { key: "transit_country", labels: ["Country of Transit"], kind: "choice", value: optionLabel(payload.transitCountry) },
    ...
    { key: "purpose", labels: ["Purpose of Travel", "Purpose of Visit"], kind: "choice", value: optionLabel(payload.purposeOfTravel), required: true },
    ...
    { key: "health_recent_travel", labels: ["recent travel history in the last 30 days"], kind: "choice", value: yesNo(payload.hasHealthSymptoms) },
    { key: "health_exposure", labels: ["history of exposure to a person who is sick"], kind: "choice", value: yesNo(payload.hasHealthSymptoms) },
    { key: "health_sick", labels: ["been sick in the past 30 days"], kind: "choice", value: yesNo(payload.hasHealthSymptoms) },
