...
export const VISA_PRODUCT_REGISTRY: Readonly<Record<string, VisaProductDefinition>> = {
  ...
  JP_VISIT_JAPAN_WEB: product({ productCode: 'JP_VISIT_JAPAN_WEB', country: 'japan', kind: 'arrival_declaration', provider: 'viza', supportLevel: 'automated', automationGate: 'requires_official_authorization', publicNotice: 'Official portal automation is gated pending Digital Agency authorization; do not promise live submission until the gate is cleared.', displayNameZh: '日本入境与海关申报', displayNameEn: 'Japan Visit Japan Web', url: '/client/application?country=japan&visaType=JP_VISIT_JAPAN_WEB' }),
  ...
  KR_E_ARRIVAL_CARD: product({ productCode: 'KR_E_ARRIVAL_CARD', country: 'south_korea', kind: 'arrival_declaration', provider: 'viza', supportLevel: 'assisted_submission', displayNameZh: '韩国电子入境卡', displayNameEn: 'Korea e-Arrival Card', url: '/client/arrival-cards/south-korea' }),
