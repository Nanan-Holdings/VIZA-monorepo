...
export const runnerConcurrencyMetrics = pgTable("runner_concurrency_metric", {
	...
	recordedIdx: index("runner_concurrency_metric_recorded_idx").on(table.recordedAt),
	eventRecordedIdx: index("runner_concurrency_metric_event_recorded_idx").on(
		table.eventType,
		table.recordedAt,
	),
}));
...
export const applicationInboxAliases = pgTable("application_inbox_aliases", {
	...
	applicantIdx: index("application_inbox_aliases_applicant_idx").on(
		table.applicantId,
		table.createdAt,
	),
}));
