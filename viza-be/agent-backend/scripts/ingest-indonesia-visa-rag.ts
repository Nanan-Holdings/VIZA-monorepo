/**
 * RAG ingestion: Indonesia visa knowledge base
 * Reads knowledge-base/indonesia-visa-rag.json -> visa_documents + visa_chunks.
 *
 * Run:
 *   npm run ingest:indonesia-visa-rag
 */
...
async function main(): Promise<void> {
  ...
  console.log("Starting Indonesia visa RAG ingestion");
  ...
  console.log("\nIndonesia visa RAG ingestion complete");
