...
const FIELDS: FieldDef[] = [
  ...
  { field_name: "emergency_contact_relationship", label: "Emergency contact relationship", field_type: "text", required: true, step_number: 4, step_name: "Contact Information", display_order: 7, placeholder: "Enter relationship to emergency contact", validation_rules: { maxLength: 40, block_group: "emergency_contact", live_dom_id: "basic_ttllLlQuanHe" } },
  ...
  { field_name: "occupation_info", label: "Current occupation details", field_type: "text", required: false, step_number: 5, step_name: "Occupation", display_order: 2, placeholder: "Enter current occupation details", validation_rules: { maxLength: 100, live_dom_id: "basic_nnNgheNghiepHienTai" } },
  ...
  { field_name: "position_course", label: "Position or course of study", field_type: "text", required: false, step_number: 5, step_name: "Occupation", display_order: 4, placeholder: "Enter position or course of study", validation_rules: { maxLength: 80, live_dom_id: "basic_nnChucVu" } },
  ...
  { field_name: "intended_ward_commune", label: "Intended ward/commune in Viet Nam", field_type: "select", required: true, step_number: 6, step_name: "Information About the Trip", display_order: 7, placeholder: "Choose ward/commune in Viet Nam", options: [], validation_rules: { dependent_on: "intended_province_city", live_dom_id: "basic_ttcdPhuongXa" } },
