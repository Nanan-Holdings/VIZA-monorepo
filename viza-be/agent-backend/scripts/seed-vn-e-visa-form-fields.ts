...
const FIELDS: FieldDef[] = [
  ...
  { field_name: "intended_ward_commune", label: "Intended ward/commune in Viet Nam", field_type: "select", required: true, step_number: 6, step_name: "Information About the Trip", display_order: 7, placeholder: "Choose ward/commune in Viet Nam", options: [], validation_rules: { dependent_on: "intended_province_city", fallbackDefault: "PHUONG MY BINH", live_dom_id: "basic_ttcdPhuongXa" } },
