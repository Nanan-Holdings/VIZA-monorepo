...
const FIELD_LABEL_ZH: Record<string, string> = {
  ...
  visa_valid_to: "电子签证有效期至哪一天？",
  passport_number: "护照号码",
  passport_issuing_authority: "护照签发机关/地点",
  passport_type: "护照类型",
...
const FIELD_HELPER_ZH: Record<string, string> = {
  ...
  intended_ward_commune: "官方门户可能会根据省/市动态加载此选项；如无法确认，请先保留可供核对的地址信息。",
