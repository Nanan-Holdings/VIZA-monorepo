...
const ACCOMMODATION_TYPES = [
  mdacOption("01", "酒店/汽车旅馆/休闲旅舍", "HOTEL/MOTEL/REST HOUSE"),
...
export const MY_MDAC_FORM_FIELDS: MyMdacFieldDef[] = [
  { field_name: "full_name", label: "Full Name as per Passport", field_type: "text", required: true, step_number: 1, step_name: "Traveller Information", display_order: 1, validation_rules: rules("护照上的姓名", { official: true }) },
  ...
  { field_name: "email_address", label: "Email Address", field_type: "text", required: true, step_number: 1, step_name: "Traveller Information", display_order: 8, validation_rules: rules("电子邮箱地址", { format: "email", official: true }) },
  { field_name: "mobile_country_code", label: "Mobile Country Code", field_type: "text", required: true, step_number: 1, step_name: "Traveller Information", display_order: 9, validation_rules: rules("手机国家 / 地区代码", { pattern: "^[0-9]{1,4}$", official: true }) },
  ...
  { field_name: "transport_number", label: "Flight / Vehicle / Vessel Number", field_type: "text", required: true, step_number: 2, step_name: "Trip Information", display_order: 4, validation_rules: rules("航班号/车辆或船舶编号", { official: true }) },
  { field_name: "last_embarkation_country", label: "Country/Region of Last Embarkation Before Malaysia", field_type: "select", required: true, step_number: 2, step_name: "Trip Information", display_order: 5, options: LOCALIZED_MY_MDAC_COUNTRIES, validation_rules: rules("抵达马来西亚前最后出发的国家/地区", { official: true }) },
  ...
  { field_name: "state", label: "State", field_type: "select", required: true, step_number: 3, step_name: "Stay in Malaysia", display_order: 3, options: LOCALIZED_MY_MDAC_STATES, validation_rules: rules("州/联邦直辖区", { official: true }) },
  {
    field_name: "city",
    label: "City",
    field_type: "select",
