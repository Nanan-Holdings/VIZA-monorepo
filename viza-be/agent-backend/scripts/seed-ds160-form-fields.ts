...
const FIELDS: FieldDef[] = [
  ...
  },
  {
    ...
    step_name: "Work/Education/Training",
    display_order: 3,
    conditional_logic: { showIf: "primary_occupation !== _empty && primary_occupation !== retired" },
    validation_rules: { has_does_not_apply: true },
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // STEP 11: Additional Work/Education/Training Information
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    required: true,
    step_number: 11,
    step_name: "Additional Work/Education/Training",
    display_order: 1,
    options: [{ value: "yes", text: "Yes" }, { value: "no", text: "No" }],
  },
  {
