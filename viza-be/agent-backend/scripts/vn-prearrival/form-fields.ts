...
export const VN_PREARRIVAL_FORM_FIELDS: VnPrearrivalFieldDef[] = [
  ...
  { field_name: "accommodation_address", label: "Accommodation Address", field_type: "text", required: true, step_number: 2, step_name: TRIP_STEP, display_order: 14, conditional_logic: showIf("accommodation_type in [residential, others]"), validation_rules: rules("住宿地址", { official: true, maxLength: 300 }) },
  { field_name: "workplace_information", label: "Workplace Information", field_type: "textarea", required: false, step_number: 2, step_name: TRIP_STEP, display_order: 15, validation_rules: rules("工作单位信息", { official: true, maxLength: 300 }) },
  { field_name: "departure_date_from_vietnam", label: "Date of departure from Vietnam (DD/MM/YYYY GMT+7)", field_type: "date", required: false, step_number: 2, step_name: TRIP_STEP, display_order: 16, validation_rules: rules("离开越南日期（DD/MM/YYYY GMT+7）", { official: true }) },
