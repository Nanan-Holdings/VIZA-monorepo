...
export const VN_PREARRIVAL_FORM_FIELDS: VnPrearrivalFieldDef[] = [
  ...
  { field_name: "visa_number", label: "Number", field_type: "text", required: true, step_number: 1, step_name: PASSENGER_STEP, display_order: 15, validation_rules: rules("编号", { official: true, maxLength: 64, helper_zh: "电子签证编号通常显示在电子签证 PDF 顶部的“登记编号 / 编号”一栏，请按官方文件原样填写。", helper_en: "For an e-visa, find this number near the top of the e-visa PDF in the Registration code / No. area and enter it exactly as shown." }) },
