...
export const PH_ETRAVEL_DEPARTURE_FORM_FIELDS: PhEtravelFieldDef[] = [
  ...
  { field_name: "mobile_country_code", label: "Mobile Country Code", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 19, validation_rules: rules("手机国家 / 地区代码", { pattern: "^[+0-9]{1,5}$", official: true, inline_group: "mobile" }) },
