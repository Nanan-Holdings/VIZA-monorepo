...
export const PH_ETRAVEL_DEPARTURE_FORM_FIELDS: PhEtravelFieldDef[] = [
  ...
  { field_name: "country_of_residence", label: "Permanent Country of Residence", field_type: "select", required: true, step_number: 2, step_name: "Traveller Information", display_order: 11.1, options: PH_ETRAVEL_COUNTRY_OPTIONS, validation_rules: rules("永久居住国家 / 地区", { official: true }) },
  { field_name: "residence_address_line1", label: "Permanent Address", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 11.2, validation_rules: rules("永久居住地址", { official: true, maxLength: 160 }) },
