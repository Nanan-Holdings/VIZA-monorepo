...
export const PH_ETRAVEL_DEPARTURE_FORM_FIELDS: PhEtravelFieldDef[] = [
  ...
  { field_name: "data_privacy_agreement", label: "By clicking Continue, you agree to the Data Privacy and Affidavit of Undertaking.", field_type: "checkbox", required: true, step_number: 1, step_name: "Travel Registration", display_order: 4, validation_rules: rules("我同意数据隐私政策与承诺书", { official: true, mustBeTrue: true }) },
  ...
  { field_name: "country_of_residence", label: "Permanent Country of Residence", field_type: "select", required: true, step_number: 2, step_name: "Traveller Information", display_order: 12, options: PH_ETRAVEL_COUNTRY_OPTIONS, validation_rules: rules("永久居住国家 / 地区", { official: true }) },
  { field_name: "residence_address_line1", label: "Permanent Address", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 13, validation_rules: rules("永久居住地址", { official: true, maxLength: 160 }) },
  { field_name: "passport_number", label: "Passport Number", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 14, validation_rules: rules("护照号码", { maxLength: 20, official: true }) },
  { field_name: "passport_issuing_authority", label: "Passport Issuing Authority", field_type: "select", required: true, step_number: 2, step_name: "Traveller Information", display_order: 15, options: PH_ETRAVEL_COUNTRY_OPTIONS, validation_rules: rules("护照签发国家", { official: true }) },
  { field_name: "passport_issue_date", label: "Passport Issued Date", field_type: "date", required: true, step_number: 2, step_name: "Traveller Information", display_order: 16, validation_rules: rules("护照签发日期", { format: "YYYY-MM-DD", official: true }) },
  { field_name: "passport_expiry_date", label: "Passport Expiry Date", field_type: "date", required: true, step_number: 2, step_name: "Traveller Information", display_order: 17, validation_rules: rules("护照有效期至", { format: "YYYY-MM-DD", official: true }) },
  { field_name: "email", label: "Email Address", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 18, validation_rules: rules("电子邮箱", { format: "email", official: true }) },
  { field_name: "mobile_country_code", label: "Mobile Country Code", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 19, placeholder: "e.g. 63", validation_rules: rules("手机国家 / 地区代码", { pattern: "^[+0-9]{1,5}$", official: true, inline_group: "mobile" }) },
  { field_name: "mobile_number", label: "Mobile Number", field_type: "text", required: true, step_number: 2, step_name: "Traveller Information", display_order: 20, validation_rules: rules("手机号码", { pattern: "^[0-9]{6,15}$", official: true, inline_group: "mobile" }) },
  ...
  { field_name: "destination_address", label: "Destination Address", field_type: "text", required: true, step_number: 3, step_name: "Philippine Departure Details", display_order: 12, validation_rules: rules("目的地地址", { official: true, maxLength: 240 }) },
  { field_name: "return_date", label: "Expected Return Date to the Philippines", field_type: "date", required: true, step_number: 3, step_name: "Philippine Departure Details", display_order: 13, conditional_logic: showIf(NEEDS_RETURN_DATE), validation_rules: rules("预计返回菲律宾日期", { format: "YYYY-MM-DD", official: true }) },
