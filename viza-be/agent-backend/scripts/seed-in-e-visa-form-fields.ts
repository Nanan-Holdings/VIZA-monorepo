...
const FIELDS: FieldDef[] = [
  ...
  { field_name: "final_declaration", label: "I hereby declare that the information furnished above is correct to the best of my knowledge and belief. In case the information is found false at any stage, I am liable for legal action, deportation, blacklisting or any other action deemed fit by the Government of India.", field_type: "checkbox", required: true, step_number: 5, step_name: "Additional Questions & Declaration", display_order: 13, options: [{ value: "yes", text: "I agree" }], validation_rules: { mustBeTrue: true, agreement_source_url: "https://www.indianvisaonline.gov.in/evisa/images/SampleForm.pdf", agreement_source_label: "Government of India e-Visa sample form" } },
];
