...
const FIELDS: FieldDef[] = [
  ...
  {
    field_name: "confirm_passport_covers_stay",
    label: "I confirm that my passport covers the period I will stay in Türkiye",
    field_type: "radio",
    required: true,
    step_number: 1,
    step_name: "Eligibility",
    ...
    validation_rules: { must_equal: "yes", official_step: "Prerequisites" },
  },
  {
    field_name: "confirm_return_ticket_accommodation_funds",
    label: "I can prove that I hold a return ticket, accommodation, and the funds required by the official portal",
    field_type: "radio",
    required: true,
    step_number: 1,
    step_name: "Eligibility",
  ...
  {
    field_name: "confirm_tourism_or_business",
    label: "I am travelling to Türkiye for tourism or business",
    field_type: "radio",
    required: true,
    step_number: 1,
    step_name: "Eligibility",
  ...
  {
    field_name: "confirm_supporting_document_valid",
    label: "I confirm that my supporting visa or residence permit is valid and is not an e-visa",
    field_type: "radio",
    required: true,
    step_number: 1,
    step_name: "Eligibility",
    display_order: 8,
    options: YES_NO_OPTIONS,
    conditional_logic: { showIf: "supporting_document_type === visa || supporting_document_type === residence_permit" },
    validation_rules: { must_equal: "yes", official_step: "Prerequisites" },
  },
  {
    field_name: "confirm_eligible_airline",
    label: "I meet the airline condition shown by the official Türkiye e-Visa portal",
    field_type: "radio",
    required: false,
    step_number: 1,
    step_name: "Eligibility",
    display_order: 9,
    options: YES_NO_OPTIONS,
    validation_rules: { dynamic_official_prerequisite: true },
  },
  {
    field_name: "confirm_entry_by_air",
    label: "I meet the entry-by-air condition shown by the official Türkiye e-Visa portal",
    field_type: "radio",
    required: false,
    step_number: 1,
    step_name: "Eligibility",
  ...
  {
    field_name: "confirm_all_official_prerequisites",
    label: "I confirm that all prerequisite statements I answered are true",
    field_type: "radio",
    required: true,
    step_number: 1,
    step_name: "Eligibility",
  ...
  {
    field_name: "supporting_document_number",
  ...
  {
    field_name: "confirm_entry_commitment",
    label: "I have read and accept any Türkiye entry commitment shown by the official portal",
    field_type: "radio",
    required: false,
    step_number: 5,
    step_name: "Supporting Document",
