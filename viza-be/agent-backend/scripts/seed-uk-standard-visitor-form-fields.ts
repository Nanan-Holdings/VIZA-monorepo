...
const FIELDS: FieldDef[] = [
  ...
  { field_name: "sex", label: "Sex", field_type: "select", required: true, step_number: 1, step_name: "About You — Personal Details", display_order: 9, options: [{ value: "male", text: "Male" }, { value: "female", text: "Female" }] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { field_name: "purpose_of_visit", label: "What is the main reason for your visit to the UK?", field_type: "select", required: true, step_number: 7, step_name: "Your Trip to the UK", display_order: 1, options: [{ value: "tourism", text: "Tourism / holiday" }, { value: "visiting_family_friends", text: "Visiting family or friends" }, { value: "business", text: "Business (meetings, conferences)" }, { value: "short_study", text: "Short-term study (up to 6 months)" }, { value: "medical", text: "Private medical treatment" }, { value: "transit", text: "Transit to another country" }, { value: "marriage_civil_partnership", text: "Marriage or civil partnership" }, { value: "ppe", text: "Permitted Paid Engagement (up to 1 month)" }, { value: "academic_12m", text: "Academic or researcher (up to 12 months)" }, { value: "organ_donor", text: "Organ donation" }, { value: "clinical_training", text: "Clinical attachment, dental observer post, PLAB or OSCE" }] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { field_name: "employment_status", label: "What is your current employment status?", field_type: "select", required: true, step_number: 9, step_name: "Your Employment", display_order: 1, options: [{ value: "employed", text: "Employed" }, { value: "self_employed", text: "Self-employed" }, { value: "student", text: "Student" }, { value: "retired", text: "Retired" }, { value: "unemployed", text: "Unemployed" }, { value: "homemaker", text: "Homemaker" }, { value: "other", text: "Other" }] },
