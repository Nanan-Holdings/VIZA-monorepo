...
const FIELDS: FieldDef[] = [
  ...
  { field_name: "fv_business_segment", label: "France-Visas sector", field_type: "select", required: true, step_number: 6, step_name: "Occupation", display_order: 2.5, conditional_logic: { showIf: "is_student === no" }, options: [
