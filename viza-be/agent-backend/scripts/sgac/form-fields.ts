...
export const SGAC_FORM_FIELDS: SgacFieldDef[] = [
  ...
  { field_name: "mobile_country_code", label: "Country/Region Code", field_type: "text", required: true, step_number: 1, step_name: "Traveller Information", display_order: 10, validation_rules: rules("手机国家 / 地区代码", { pattern: "^[0-9]{1,4}$", official: true }) },
  ...
  { field_name: "last_city_or_port_before_singapore", label: "Last City/Port of Embarkation Before Singapore", field_type: "select", required: true, step_number: 2, step_name: "Trip Information", display_order: 3, options: CITY_PORTS, validation_rules: rules("抵达新加坡前最后出发的城市/港口", { source: "ICA_SGAC_CITY", official: true }) },
