...
export const SGAC_FORM_FIELDS: SgacFieldDef[] = [
  ...
  { field_name: "carrier_name", label: "Name of Airline/Vessel/Transport Operator", field_type: "text", required: true, step_number: 2, step_name: "Trip Information", display_order: 8, conditional_logic: showIf("mode_of_travel === sea || mode_of_travel === air && air_transport_type === private"), validation_rules: rules("航空公司 / 船舶 / 交通运营方名称", { maxLength: 100, official: true }) },
