...
export function ChatShell() {
  ...
  const artifactVisible = isHydrated ? isArtifactVisible : false;
        ...
        >
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-background md:rounded-tl-[12px] md:border-t md:border-l md:border-border/40">
            <Messages
              ...
              chatId={chatId}
              isArtifactVisible={artifactVisible}
              isLoading={isLoading}
              isReadonly={isReadonly}
              messages={messages}
              onEditMessage={(msg) => {
              ...
              status={status}
              votes={votes}
              sendMessage={sendMessage} // 👈 关键新增（只改这一行）
            />
