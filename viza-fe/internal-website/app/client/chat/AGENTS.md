...
- Taiwan is supported via `TW_ENTRY_PERMIT` (Taiwan Online Entry Permit): mainland Chinese nationals residing abroad or in Hong Kong/Macau applying to visit Taiwan. Chat must redirect to `/client/application?country=taiwan&visaType=TW_ENTRY_PERMIT`, never collect its fields inline.
