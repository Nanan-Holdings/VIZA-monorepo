...
const COPY = {
  en: {
    ...
    subtitle: "What needs attention now across applications, official submission, and result delivery.",
    openWork: "Open work",
    ...
    operationalQueuesDescription: "Live workloads across customer, application, and platform operations.",
    queue: "Priority work",
  ...
  zh: {
    title: "运营控制台",
    subtitle: "集中查看申请、官方提交与结果交付当前需要处理的事项。",
    openWork: "处理中工作",
    unassigned: "未分配",
    overdue: "已超时",
    systemSignals: "系统异常",
    ...
    operationalQueuesDescription: "客户、申请与平台运营的实时工作量。",
    queue: "优先工作",
    signals: "尚未同步为工作项的异常",
    noWork: "没有待处理工作项。",
    noSignals: "没有活动异常。",
...
export default async function AdminDashboardPage() {
  ...
  const [work, runners, support, portals, takeovers, dlq, leads, privacy, appointments] = await Promise.all([
  ...
  const sourceErrors = [work, runners, support, portals, takeovers, dlq, leads, privacy, appointments]
