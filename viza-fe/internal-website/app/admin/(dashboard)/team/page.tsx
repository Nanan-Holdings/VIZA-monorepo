...
import { listAdminRegistrationInvites } from "@/app/actions/admin-access";
...
export default async function AdminTeamPage() {
  ...
  const [staffResult, workResult, supportResult, leadsResult, invites] = await Promise.all([
  ...
  return <div className="mx-auto w-full max-w-6xl space-y-6 p-4 md:p-8">
    ...
    <InviteManager locale={locale} invites={invites} />
