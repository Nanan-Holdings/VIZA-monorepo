...
import { enqueueSgacRunnerRetry } from "@/lib/queue/enqueue";
import {
...
export async function POST(
  ...
  if (useSgacCountryRunner) {
    try {
      ...
      // legacy enqueue RPC, which will atomically reuse that protected row.
    } catch (error) {
      // Migration safety valve: if the RPC is unavailable or country wake
