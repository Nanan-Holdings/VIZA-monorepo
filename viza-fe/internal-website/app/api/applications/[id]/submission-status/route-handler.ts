...
async function getSubmissionStatus(
  ...
  // An explicit retry always supersedes an older terminal result. Historical
  // Taiwan handoff data is internal-only and must never hide active background
  // submission progress from the applicant.
