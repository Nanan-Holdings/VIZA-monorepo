...
export const NON_SCHENGEN_VISA_DESTINATIONS: PopularVisaDestination[] = sortDestinations([
  ...
  destination({
    ...
    visaName: "Tourism Entry / MDAC / eVisa",
    visaNameZh: "旅游入境 / MDAC / 电子签证",
    description: "Tourism intake for Malaysia Digital Arrival Card, visa-exempt or eVisa routes.",
    descriptionZh: "适合马来西亚数字入境卡 MDAC、免签或电子签证路径的信息采集。",
    flag: "🇲🇾",
    region: "Asia",
  ...
  destination({
    ...
    visaName: "Entry Visa / SG Arrival Card",
    visaNameZh: "入境签证 / SG Arrival Card",
    description: "Visitor entry visa and SG Arrival Card preparation for Singapore travel.",
    descriptionZh: "适合新加坡入境签证和 SG Arrival Card 资料准备。",
    flag: "🇸🇬",
    region: "Asia",
    searchAliases: ["SG Arrival Card", "ICA Singapore"],
  }),
  destination({
  ...
  destination({
    ...
    countryName: "Taiwan",
    countryNameZh: "中国台湾",
    visaType: "twac_or_visitor_visa",
    visaName: "TW Arrival Card / Visitor Visa",
    visaNameZh: "TWAC 入境卡 / 访客签证",
    description: "Taiwan Arrival Card and visitor visa intake for short stays.",
    descriptionZh: "适合台湾 TWAC 在线入境卡和短期访客签证资料采集。",
    flag: "🇹🇼",
    region: "Asia",
    searchAliases: ["TWAC", "Taiwan Arrival Card"],
  }),
  destination({
    country: "tanzania",
  ...
  destination({
    ...
    visaName: "Tourist Entry / TDAC",
    visaNameZh: "旅游入境 / TDAC",
    description: "Tourism intake for Thailand Digital Arrival Card, visa-exempt or tourist visa routes.",
    descriptionZh: "适合泰国数字入境卡 TDAC、免签或旅游签证路径的信息采集。",
    flag: "🇹🇭",
    region: "Asia",
