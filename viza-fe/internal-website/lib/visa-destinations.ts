...
export const NON_SCHENGEN_VISA_DESTINATIONS: PopularVisaDestination[] = sortDestinations([
  ...
  destination({
    ...
    countryNameZh: "加拿大",
    visaType: "CA_TRV",
    visaName: "Tourist Visitor Visa (TRV)",
    visaNameZh: "访客签证",
    description: "Temporary resident visa intake for tourism; eTA eligibility is routed separately.",
    descriptionZh: "适合赴加拿大旅游的临时居民签证；eTA 资格另行分流。",
    flag: "🇨🇦",
  ...
  destination({
    ...
    visaNameZh: "电子旅游签证",
    description: "Official e-Tourist Visa intake for recreation, sightseeing and eligible short tourist activities.",
    descriptionZh: "适合赴印度休闲、观光及其他符合条件的短期旅游活动。",
    flag: "🇮🇳",
    region: "Asia",
  }),
  destination({
  ...
  destination({
    ...
    visaNameZh: "入境卡",
    description: "One Singapore Arrival Card form with ICA's in-form residency type selection.",
    descriptionZh: "一个新加坡入境卡表单，并在表单内选择 ICA 居留身份类型。",
    flag: "🇸🇬",
    region: "Asia",
  ...
  destination({
    ...
    visaName: "Taiwan Online Entry Permit",
    visaNameZh: "台湾入境许可证",
    description: "Online entry permit application for mainland Chinese nationals residing abroad or in Hong Kong/Macau visiting Taiwan.",
    descriptionZh: "适合旅居海外或港澳的大陆地区人民申请来台观光入境许可证的信息采集。",
    flag: "🇹🇼",
    region: "Asia",
  ...
  destination({
    ...
    visaName: "Tourist e-Visa",
    visaNameZh: "旅游电子签证",
    description: "Official e-Visa intake for eligible tourist travel to Türkiye.",
    descriptionZh: "适合符合条件的土耳其旅游电子签证申请。",
    flag: "🇹🇷",
    region: "Europe / Asia",
  ...
  destination({
    ...
    visaName: "5-Year Multiple-Entry Tourist Visa",
    visaNameZh: "五年多次入境旅游签证",
    description: "ICP self-sponsored five-year multiple-entry tourist visa for stays of up to 90 days per year.",
    descriptionZh: "阿联酋 ICP 自助申请的五年多次入境旅游签证，每年最多停留 90 天。",
    flag: "🇦🇪",
    region: "Middle East",
...
const VISA_TYPE_LABELS: Record<string, string> = {
  ...
  CA_TRV: "Tourist Visitor Visa (TRV)",
  IN_E_VISA: "e-Tourist Visa",
  SA_E_VISA: "Tourist eVisa",
  TR_E_VISA: "Tourist e-Visa",
  AE_TOURIST_VISA: "5-Year Multiple-Entry Tourist Visa",
...
const VISA_TYPE_LABELS_ZH: Record<string, string> = {
  ...
  SA_E_VISA: "旅游电子签证",
  TR_E_VISA: "旅游电子签证",
  AE_TOURIST_VISA: "五年多次入境旅游签证",
  visitor_subclass_600: "澳大利亚 600 类访客签证",
  visitor_visa: "访客签证",
  VN_E_VISA: "电子签证",
  ...
  tourist_visa_or_ave: "旅游签证 / 电子旅行授权",
  tourist_visa: "旅游签证",
  tourist_l_visa: "L 类旅游签证",
  check_mig_or_visitor_visa: "入境预登记 / 访客签证",
  dviajeros_entry_form: "旅客入境申报",
  eticket_entry_exit: "电子入出境表",
  short_stay_c_visit_visa: "短期 C 类访问签证",
  eta_il_or_visitor_visa: "电子旅行授权 / 访客签证",
  evisa_or_visitor_visa: "电子签证 / 访客签证",
  eta_travel_authorization: "电子旅行授权",
  unified_evisa: "统一电子签证",
  TW_ENTRY_PERMIT: "台湾入境许可证",
  visa_free_or_evisa: "访客入境 / 电子签证",
  visa_free_14_days_or_evisa: "访客入境 / 电子签证",
  hayya_a1_tourist_visa: "A1 旅游签证",
