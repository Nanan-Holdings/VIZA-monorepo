...
const ZH_LABELS: Record<string, string> = {
  ...
  "Full Name in Native Alphabet": "母语全名",
  "Telecode (4-digit non-Roman script code)": "中文电码（4位数字）",
...
const ZH_OPTIONS: Record<string, string> = {
  ...
  "MARRIED": "已婚 (MARRIED)",
  "Married": "已婚",
  "COMMON LAW MARRIAGE": "同居婚姻 (COMMON LAW MARRIAGE)",
  "CIVIL UNION/DOMESTIC PARTNERSHIP": "民事结合/同居伴侣 (CIVIL UNION/DOMESTIC PARTNERSHIP)",
  "SINGLE": "未婚 (SINGLE)",
  "Single": "未婚",
  "WIDOWED": "丧偶 (WIDOWED)",
  "Widowed": "丧偶",
