...
const ZH_LABELS: Record<string, string> = {
  ...
  "Telecode (4-digit non-Roman script code)": "电码（4位非罗马文字代码）",
  ...
  "Home Address — Street Address Line 2": "家庭地址——街道地址第2行",
  ...
  "U.S. Contact — Organization (if not a person)": "美国联系人——组织（如非个人）",
