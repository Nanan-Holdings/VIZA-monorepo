  ...
  [
    ...
    },
    {
      ...
      requiredBehavior: [
        ...
        "Consume E23 Health only through createPhEtravelHealthPresentation(). Keep antigen vaccine/age, recent-country Yes, and symptoms Yes branches as client-known/server-unknown review states; bats/animals translation text is not a rendered question.",
      ],
      forbiddenBehavior: [
