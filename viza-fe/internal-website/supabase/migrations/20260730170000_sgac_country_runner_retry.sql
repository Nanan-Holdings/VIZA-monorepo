-- Canonical copy: viza-be/agent-backend/drizzle/0126_sgac_country_runner_retry.sql
-- Kept in the website migration track because this RPC is called by the
-- authenticated retry API.
