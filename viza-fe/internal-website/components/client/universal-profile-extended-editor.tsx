    ...
    <ApplicationFormPanel className="scroll-mt-28 p-4 sm:p-6 md:p-8">
      ...
      {!schemaAvailable ? (
        <Alert variant="warning" className="mt-4">
          ...
          <AlertDescription><p>{isZh ? "完整资料表尚未安装数据库迁移；现有基础资料仍可正常使用。" : "The expanded profile migration is not installed yet. Existing core profile data still works."}</p></AlertDescription>
        </Alert>
      ) : null}
