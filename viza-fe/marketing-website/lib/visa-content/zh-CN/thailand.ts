...
export const thailand: VisaContent = {
  ...
  steps: [
    ...
    },
    {
      ...
      statusRows: [
        { label: "申请已提交至电子签证门户", ts: "7月8日 上午 8:30" },
        { label: "材料已转交领事官员", ts: "7月8日 上午 11:00" },
        { label: "等待领事审批", ts: "处理中" },
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      category: "申请流程",
      q: "泰国电子签证需要多长时间？",
      a: "领事审理通常在付款后5–10个工作日完成。泰国驻新加坡大使馆建议至少提前21个工作日申请，且在电子签证获批前须留在新加坡——请尽早启动。我们会尽早递交并持续跟进，但出签时间由官方决定。",
    },
    {
      category: "申请流程",
      q: "可以为全家同时申请吗？",
  ...
  price: {
    ...
    title: "电子签证（TR）· 60天停留",
    saving: "比直接申请更快",
    sub: "含50新元政府费、材料审核与 TDAC 代填，一价全包。",
    foot: "政府费与 VIZA 服务费在结账时一并收取。办理时间为估算值，最终由官方决定。",
  },
