...
export const malaysia: VisaContent = {
  ...
  steps: [
    ...
    },
    {
      ...
      statusRows: [
        { label: "申请已在官方 eVISA 系统递交", ts: "8月15日 上午8:30" },
        { label: "移民局审核中", ts: "8月15日 下午2:00" },
        { label: "等待最终批准", ts: "进行中" },
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "官方审理时间为 48 小时，且仅计工作日——周末及马来西亚和您所在国的公共假期不计入。移民局建议至少提前 2 周申请。VIZA 收到材料后立即递交、全程监控，但出签时间由移民局决定。",
    },
    {
      category: "申请流程",
      q: "马来西亚 eVISA 需要多少费用？",
      a: "政府签证费按国籍收取，为 RM 20 至 RM 50（约 6–15 新元；中国公民为 RM 30）。在线系统另收手续费，普遍报道约为 RM 105（约 32 新元）。VIZA 在结账时给出一个全包价，涵盖政府费用与材料审核。",
    },
    {
      category: "退款、拒签与重新申请",
  ...
  price: {
    ...
    saving: "比自行申请快 1 天",
    sub: "含政府费用与材料审核，全包价格。",
    foot: "政府费用与 VIZA 服务费在结账时一并收取。办理时间为估算值，最终由官方决定。",
  },
