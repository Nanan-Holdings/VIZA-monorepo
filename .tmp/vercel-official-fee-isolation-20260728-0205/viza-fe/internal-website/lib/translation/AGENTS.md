...
Realtime bilingual field helpers must call `/api/translate` and never call
Google from the browser. Return typed provider results and avoid logging
applicant-entered text.
