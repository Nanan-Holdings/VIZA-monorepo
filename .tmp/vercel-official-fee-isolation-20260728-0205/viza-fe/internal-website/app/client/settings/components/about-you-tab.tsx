...
function FieldRow({ label, children }: FieldRowProps) {
  return (
    <div className="flex flex-col gap-2">
      <p
        className={`${geist.className} text-[16px] sm:text-[18px] font-medium text-[#989898]`}
      >
        {label}
      </p>
      {children}
...
function InfoCard({ children }: InfoCardProps) {
  return (
    <motion.div
      className="w-full rounded-[12px] border border-[#efefef] bg-white p-4 sm:p-6"
            ...
            {section.title === "Profile" ? (
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 rounded-full border-2 border-[#c1785d] px-4 py-2 text-[14px] font-medium text-[#c1785d] shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-all duration-200 hover:bg-[#c1785d0d] sm:px-6 sm:py-3 sm:text-base"
