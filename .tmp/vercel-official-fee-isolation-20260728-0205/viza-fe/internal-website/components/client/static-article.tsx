...
export function StaticArticle({ title, subtitle, sections }: StaticArticleProps) {
  return (
    <div className="font-sofia-pro bg-[#fbfbf9] relative min-h-screen overflow-x-hidden w-full">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 sm:px-6 md:px-10 xl:px-20 pt-[60px] sm:pt-[100px]">
        {/* Hero title */}
        <motion.div
          className="font-sofia-pro font-medium leading-[1.2] not-italic text-[30px] sm:text-[38px] lg:text-[44px] text-white mt-16 tracking-[-1.2px] sm:tracking-[-1.4px] lg:tracking-[-1.76px] w-full max-w-[720px]"
